        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    sku = product.sku;
                    console.log("Using SKU: ".concat(sku));
                    d1 = new Date();
                    d1.setHours(0, 0, 0, 0);
                    d2 = new Date();
                ...
                case 3:
                    _a.sent();
                    // 2. Create Campaigns
                    return [4 /*yield*/, prisma.adsCampaign.createMany({
                            data: [
                                {
                                    date: d1,
                                    campaign: "Mock-".concat(Date.now(), "-A"),
                                    country: 'IT',
                                    platform: 'TikTok',
                                    sku: sku,
                                    stage: 'Test',
                                ...
                                {
                                    date: d2,
                                    campaign: "Mock-".concat(Date.now(), "-B"),
                                    country: 'DE',
                                    platform: 'Facebook',
                                    sku: sku,
                                    stage: 'Scale',

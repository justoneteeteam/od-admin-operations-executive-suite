...
async function main() {
    ...
    const templates = [
        ...
        },
        {
            ...
            bodyTemplate: 'Ciao {{1}}, il tuo ordine {{2}} e in arrivo. Sara consegnato entro 3-5 ore. Grazie per l\'acquisto!',
            variables: { 1: 'Customer Name', 2: 'Order Number' },
            language: 'it',
            isActive: true,
        },
        ...
        // --- Pre-Call SMS Warning Templates ---
        {
            ...
            bodyTemplate: 'Hola {{1}}, procesamos tu pedido {{2}}. En breve te llamaremos del numero {{3}} para confirmarlo. Por favor contesta!',
            variables: { 1: 'Customer Name', 2: 'Order Number', 3: 'Twilio Phone Number' },
            language: 'es',
            isActive: true,
        },
        {
            ...
            bodyTemplate: 'Ciao {{1}}, stiamo elaborando l\'ordine {{2}}. A breve ti chiameremo dal numero {{3}} per confermarlo. Rispondi!',
            variables: { 1: 'Customer Name', 2: 'Order Number', 3: 'Twilio Phone Number' },
            language: 'it',
            isActive: true,
        },
        {
            ...
            templateType: 'sms',
            subject: 'Call Notice',
            bodyTemplate: 'Hi {{1}}, we are processing your order {{2}}. We will call you shortly from {{3}} to confirm it. Please pick up!',
            variables: { 1: 'Customer Name', 2: 'Order Number', 3: 'Twilio Phone Number' },
            language: 'en',
            isActive: true,
        },

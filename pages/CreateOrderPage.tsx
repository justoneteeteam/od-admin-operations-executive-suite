        ...
        <div className="flex flex-col gap-8 max-w-5xl mx-auto pb-20">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2">
                    <button onClick={() => navigate('/orders')} className="text-text-muted hover:text-on-surface transition-colors flex items-center gap-1">
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-4">
                    ...
                    <div className="flex gap-3 w-full md:w-auto">
                        <button
                            ...
                            className="flex-1 md:flex-none flex items-center justify-center rounded-xl h-11 px-6 bg-surface-container text-on-surface text-xs font-bold uppercase tracking-widest border border-outline-variant hover:bg-surface-container transition-all"
                        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <section className="bg-surface-lowest rounded-2xl border border-border-dark overflow-hidden shadow-sm">
                        <div className="px-6 py-4 border-b border-border-dark bg-surface-low flex items-center gap-2">
                            <span className="material-symbols-outlined text-primary">info</span>
                            <h3 className="text-[10px] font-black uppercase tracking-widest text-on-surface">Order Information</h3>
                        </div>
                        <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-text-muted uppercase ml-1">Order ID</label>
                                <input
                                    className="bg-surface-high border-outline-variant text-on-surface text-sm rounded-xl w-full h-11 px-4 font-mono opacity-80"
                                    value={orderId}
                                    readOnly
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <input
                                    className="bg-surface-high border-outline-variant text-on-surface text-sm rounded-xl w-full h-11 px-4 opacity-80"
                                    value={orderDate}
                                    readOnly
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <select
                                    className="bg-surface-high border-outline-variant text-on-surface text-sm rounded-xl w-full h-11 px-4 focus:ring-primary/40 focus:border-primary"
                        ...
                        <div className="px-6 pb-6">
                            <div className="space-y-2">
                                ...
                                <select
                                    className="bg-surface-high border-outline-variant text-on-surface text-sm rounded-xl w-full h-11 px-4 focus:ring-primary/40 focus:border-primary appearance-none"
                    ...
                    <section className="bg-surface-lowest rounded-2xl border border-border-dark overflow-hidden shadow-sm">
                        <div className="px-6 py-4 border-b border-border-dark bg-surface-low flex items-center gap-2">
                            ...
                            <h3 className="text-[10px] font-black uppercase tracking-widest text-on-surface">Customer Information</h3>
                        </div>
                        <div className="p-6 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        className={`bg-surface-high border-outline-variant text-on-surface text-sm rounded-xl w-full h-11 px-4 focus:ring-primary/40 ${errors.phoneNumber ? 'border-red-500' : ''}`}
                                        placeholder="+39 --- --- ----"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        className="bg-surface-high border-outline-variant text-on-surface text-sm rounded-xl w-full h-11 px-4"
                                        placeholder="Via/Apt #"
                    ...
                    <section className="bg-surface-lowest rounded-2xl border border-border-dark overflow-hidden shadow-sm">
                        <div className="px-6 py-4 border-b border-border-dark bg-surface-low flex items-center gap-2">
                            ...
                            <h3 className="text-[10px] font-black uppercase tracking-widest text-on-surface">Product Information</h3>
                        </div>
                        <div className="p-6 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <select
                                        className="bg-surface-high border-outline-variant text-on-surface text-sm rounded-xl w-full h-11 px-4 focus:ring-primary/40"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        className="bg-surface-high border-outline-variant text-on-surface/60 text-sm rounded-xl w-full h-11 px-4 font-mono cursor-not-allowed"
                ...
                <div className="space-y-8">
                    ...
                    <section className="bg-surface-lowest rounded-2xl border border-border-dark overflow-hidden shadow-sm">
                        <div className="px-6 py-4 border-b border-border-dark bg-surface-low flex items-center gap-2">
                            ...
                            <h3 className="text-[10px] font-black uppercase tracking-widest text-on-surface">Execution Status</h3>
                        </div>
                        <div className="p-6 space-y-6">
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    className="bg-surface-high border-outline-variant text-on-surface text-sm rounded-xl w-full h-11 px-4 font-mono"
                        ...
                        <div className="p-6 space-y-5">
                            {logs.map((log, i) => (
                                <div key={i} className="flex gap-4 relative">
                                    ...
                                    <div className="z-10 mt-1 size-6 rounded-full bg-surface-high border border-border-dark flex items-center justify-center shrink-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-8 border-t border-border-dark">
                <button
                    ...
                    disabled={saving}
                    className="flex-1 h-12 bg-surface-container hover:bg-surface-container text-on-surface text-xs font-black uppercase tracking-widest rounded-xl transition-all border border-border-dark disabled:opacity-50"
                >
                    Cancel
                </button>
                <button
                    ...
                    disabled={saving}
                    className="flex-1 h-12 bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500 hover:text-on-surface border border-emerald-500/20 text-xs font-black uppercase tracking-widest rounded-xl transition-all disabled:opacity-50"
                >
                ...
                <button
                    ...
                    disabled={saving}
                    className="flex-[2] h-12 bg-primary hover:bg-primary/90 text-on-surface text-xs font-black uppercase tracking-widest rounded-xl transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-3 disabled:opacity-50"
                >
            ...
            {showBlockedModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
                    <div className="bg-[#0b111a] border border-white/10 rounded-2xl p-8 flex flex-col items-center gap-5 shadow-2xl max-w-sm w-full relative">
                        ...
                        <h3 className="text-xl font-bold text-on-surface tracking-tight">Customer Blocked</h3>

                        <div className="h-1 w-12 bg-white/10 rounded-full mb-4"></div>

                        <button
                            onClick={() => setShowBlockedModal(false)}
                            className="w-full h-11 bg-white/5 hover:bg-white/10 text-on-surface text-sm font-medium rounded-xl transition-all border border-white/5"
                        >
                            Close
                        </button>
                    </div>
